...
public class TextHologramData extends DisplayHologramData {
    ...
    public static final Display.TextDisplay.Align DEFAULT_TEXT_ALIGNMENT = Display.TextDisplay.Align.CENTER;
    ...
    private Display.TextDisplay.Align textAlignment = DEFAULT_TEXT_ALIGNMENT;
    ...
    public TextHologramData setTextAlignment(Display.TextDisplay.Align textAlignment) {
