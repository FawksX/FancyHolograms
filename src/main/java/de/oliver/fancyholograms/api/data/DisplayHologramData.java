...
public class DisplayHologramData extends HologramData {
    ...
    public static final Display.TextDisplay.BillboardConstraints DEFAULT_BILLBOARD = Display.TextDisplay.BillboardConstraints.CENTER;
    ...
    private Display.TextDisplay.BillboardConstraints billboard = DEFAULT_BILLBOARD;
    ...
    public Display.TextDisplay.BillboardConstraints getBillboard() {
        return billboard;
    }

    public DisplayHologramData setBillboard(Display.BillboardConstraints billboard) {
    ...
    public DisplayHologramData setBrightness(Brightness brightness) {
    ...
    public boolean write(ConfigurationNode section, String name) {
        ...
        if(brightness != null) {
            section.set("block_brightness", brightness.block());
            section.set("sky_brightness", brightness.sky());
        }

        section.set("billboard", billboard != Display.BillboardConstraints.CENTER ? billboard.name().toLowerCase(Locale.ROOT) : null);
